function SpawnRegions()
	return {
		...
		{ name = "Region: Rosewood, KY", file = "media/maps/TC_Rosewood/spawnpoints.lua" },
		{ name = "Region: Slocan Lake, BC", file = "media/maps/TC_SlocanLake/spawnpoints.lua" },
    	{ name = "Region: West Point, KY", file = "media/maps/TC_WestPoint/spawnpoints.lua" },
        { name = "Role: Insurgent", file = "media/maps/InsurgentSpawn/spawnpoints.lua" },
        { name = "Role: Knox County Traveler", file = "media/maps/TC_Traveler/spawnpoints.lua" }
	}
end
